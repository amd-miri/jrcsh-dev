 ...
 * Create a tablesorter interface and sort on the first and secound column column headers.
 *
 * example $('table').tablesorter({ headers: { 0: { sorter: false}, 1: {sorter: false} } });
 * Create a tablesorter interface and disableing the first and second  column headers.
 *
 * example $('table').tablesorter({ headers: { 0: {sorter:"integer"}, 1: {sorter:"currency"} } });
 * Create a tablesorter interface and set a column parser for the first and second column.
 *
 * @param Object
