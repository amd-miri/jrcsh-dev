...
<?php if (isset($variables['element']['#items'][0]['value2']) && $variables['element']['#items'][0]['value'] != $variables['element']['#items'][0]['value2']) : ?>
  ...
  <div class="date-cont end-date">
    ...
    <span class="day"><?php print format_date(strtotime($variables['element']['#items'][0]['value2']), 'jrc_day'); ?></span>
    <span class="year"><?php print format_date(strtotime($variables['element']['#items'][0]['value2']), 'jrc_year'); ?></span>
  </div>
<?php endif; ?>
</div>
