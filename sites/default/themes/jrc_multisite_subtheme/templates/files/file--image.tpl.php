...
<div id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      <?php if(isset($content['file']['#item']['field_file_image_title_text'][LANGUAGE_NONE][0]['value'])): ?>
        <div> <?php print $content['file']['#item']['field_file_image_title_text'][LANGUAGE_NONE][0]['value']; ?> </div>
      <?php endif; ?>
