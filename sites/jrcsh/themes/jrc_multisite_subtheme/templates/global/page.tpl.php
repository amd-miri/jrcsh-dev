...
?>
  ...
  <div id="layout-body" class="container">
    ...
    <div class="row">
      <?php if ($regions['landing_page_banner']): ?>
      <div id="landing-page-banner" class="col-lg-<?php print ($cols['landing_page_banner']['lg']); ?> col-md-<?php print ($cols['landing_page_banner']['md']); ?> col-sm-<?php print ($cols['landing_page_banner']['sm']); ?> col-xs-<?php print ($cols['landing_page_banner']['xs']); ?> landing-page-banner">
        <?php print $regions['landing_page_banner']; ?>
      </div>
      <?php endif; ?>
      
      <?php if ($regions['landing_page_banner_text']): ?>
      <div id="landing-page-banner-text" class="col-lg-<?php print ($cols['landing_page_banner_text']['lg']); ?> col-md-<?php print ($cols['landing_page_banner_text']['md']); ?> col-sm-<?php print ($cols['landing_page_banner_text']['sm']); ?> col-xs-<?php print ($cols['landing_page_banner_text']['xs']); ?> landing-page-banner-text">
        <?php print $regions['landing_page_banner_text']; ?>
      </div>
      <?php endif; ?>
      ...
      <?php if ($regions['page_header']): ?>
      <div id="page-header" class="col-lg-<?php print ($cols['page_header']['lg']); ?> col-md-<?php print ($cols['page_header']['md']); ?> col-sm-<?php print ($cols['page_header']['sm']); ?> col-xs-<?php print ($cols['page_header']['xs']); ?> custom-page-header">
        <?php print $regions['page_header']; ?>
      </div>
      <?php endif; ?>
      ...
      <div id="content-wrapper" class="col-lg-<?php print $cols['content_main']['lg']; ?> col-md-<?php print $cols['content_main']['md']; ?> col-sm-<?php print $cols['content_main']['sm']; ?> col-md-<?php print $cols['content_main']['xs']; ?>">
        ...
        <div class="row">
          ...
          <div class="col-lg-<?php print $cols['content']['lg']; ?> col-md-<?php print $cols['content']['md']; ?> col-sm-<?php print $cols['content']['sm']; ?> col-xs-<?php print $cols['content']['xs']; ?>">
            ...
            <a id="content"></a>
            <?php if ($title && (!isset($variables['node']) || path_is_admin(current_path()))): ?>
            <h1 class="title-page">
              <?php print $title; ?>
            </h1>
            <?php endif; ?>
